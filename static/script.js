/**
 * Purdue Research Matchmaker - COMPLETE WORKING VERSION
...
const researchAreas = [
  { title: "Artificial Intelligence", description: "Systems that learn, reason, and make decisions using data and computational models.", keywords: ["ai", "machine learning", "learning", "algorithms", "intelligence"] },
  { title: "Machine Learning", description: "Algorithms that identify patterns and improve performance through experience and data.", keywords: ["machine learning", "learning", "algorithms", "data science", "optimization"] },
  { title: "Natural Language Processing", description: "Techniques for understanding, generating, and analyzing human language.", keywords: ["nlp", "language", "text", "processing", "computational linguistics"] },
  { title: "Human-Computer Interaction", description: "Designing technology that improves how people interact with software, devices, and AI systems.", keywords: ["hci", "interaction", "human", "interface", "design", "ui", "usability"] },
  { title: "Security & Privacy", description: "Protecting systems, networks, and data from unauthorized access and cyber threats.", keywords: ["security", "privacy", "access control", "cybersecurity", "protection"] },
  { title: "Computer Vision", description: "Enabling computers to interpret images, video, and visual information.", keywords: ["vision", "computer vision", "image", "graphics", "robotics", "visual"] },
  { title: "Data Science & Analytics", description: "Extracting insights from large datasets using statistical and computational methods.", keywords: ["data science", "analytics", "data mining", "statistics", "data analysis"] },
  { title: "Database Systems", description: "Designing and managing efficient systems for storing, retrieving, and processing data.", keywords: ["database", "data management", "storage", "retrieval", "systems"] },
  { title: "Algorithms & Theory", description: "Studying computational methods, optimization, and the mathematical foundations of computing.", keywords: ["algorithms", "theory", "optimization", "computational", "mathematical"] },
  { title: "Programming Languages & Software Engineering", description: "Building reliable software systems, compilers, development tools, and programming frameworks.", keywords: ["programming", "languages", "compiler", "software", "development"] },
  { title: "Robotics & Autonomous Systems", description: "Developing intelligent machines capable of sensing, planning, and acting in physical environments.", keywords: ["robotics", "autonomous systems", "robots", "control", "intelligent machines"] },
  { title: "Computational Biology & Health Informatics", description: "Applying computing, AI, and data analysis to biological, medical, and healthcare challenges.", keywords: ["computational biology", "health informatics", "medical", "biological", "healthcare"] }
];
